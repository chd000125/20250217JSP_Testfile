        ...
        <div class="modules-container">
            ...
            <div class="module-wrapper">
                ...
                <div class="module-content">
                    ...
                    <iframe src="http://localhost:8082/" class="module-frame" id="module2Frame" onload="hideLoading('loading2')" scrolling="no"></iframe>
                </div>
                <div class="module-footer">
                    <a href="http://localhost:8082/" target="_blank" class="module-link">모듈 2 전체보기</a>
                </div>
            </div>
        </div>
    </div>
