...
//    }
    ...
    public int addUser(User users) {
        ...
        return jdbcTemplate.update(sql, users.getUsername(), users.getEmail(), users.getPassword());
    }
    ...
    // 사용자 정보 수정
    public int updateUser(Long id, String username, String email, String password) {
        String sql = "UPDATE users SET username = ?, email = ?, password = ? WHERE id = ?";
        return jdbcTemplate.update(sql, username, email, password, id);
    }
